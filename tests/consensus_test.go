...
func TestConsensus2(t *testing.T) {
	...
	if len(consens.Edges()) > ntips {
		t.Error("Strict Consensus of 3 random binary trees (1000 tips) should be a star tree")
	}
}
