...
```
gotree generate yuletree --seed 10 | gotree support setrand --seed 10 | gotree draw svg -r -w 200 -H 200 --with-branch-support --support-cutoff 0.7 -o commands/draw_1.svg
```
...
```
gotree generate yuletree --seed 10 | gotree support setrand --seed 10 | gotree draw svg -c -w 200 -H 200 --with-branch-support --support-cutoff 0.7 -o commands/draw_2.svg
```
...
```
gotree generate yuletree --seed 10 | gotree support setrand --seed 10 | gotree draw svg -w 200 -H 200 --with-branch-support --support-cutoff 0.7 -o commands/draw_3.svg
```
