...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.gotree.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".gotree") // name of config file (without extension)
